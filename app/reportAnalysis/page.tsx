...
const [selectedFile, setSelectedFile] = useState<File | null>(null);
  ...
  const totalInsights = files.reduce((acc, file) => acc + (file.insights?.length || 0), 0)
      ...
      <div className="container mx-auto py-8 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <Card className="bg-blue-50 shadow-md hover:shadow-lg transition-shadow rounded-xl border border-blue-100">
              ...
              <CardContent className="pt-4">
                ...
                <p className="text-xs text-gray-500">
                  {completedFiles} analyzed, {files.length - completedFiles} pending
                </p>
                <div className="mt-3">
                  <Progress value={(completedFiles / Math.max(files.length, 1)) * 100} className="h-2 bg-blue-100" />
                </div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="bg-white shadow-md hover:shadow-lg transition-shadow rounded-xl border border-purple-100">
              <CardHeader className="flex flex-row items-center justify-between pb-2 bg-gradient-to-r from-purple-50 to-purple-100 rounded-t-xl">
                <CardTitle className="text-sm font-semibold text-purple-700">AI Insights</CardTitle>
                <BarChart3 className="h-4 w-4 text-purple-500" />
              </CardHeader>
              <CardContent className="pt-4">
                <div className="text-2xl font-bold text-gray-800">{totalInsights}</div>
                <p className="text-xs text-gray-500">Across {completedFiles} reports</p>
          ...
          >
            <Card className="bg-white shadow-md hover:shadow-lg transition-shadow rounded-xl border border-green-100">
              <CardHeader className="flex flex-row items-center justify-between pb-2 bg-gradient-to-r from-green-50 to-green-100 rounded-t-xl">
                <CardTitle className="text-sm font-semibold text-green-700">Health Score</CardTitle>
                <LineChart className="h-4 w-4 text-green-500" />
              </CardHeader>
              <CardContent className="pt-4">
                <div className="text-2xl font-bold text-gray-800">87/100</div>
                <p className="text-xs text-gray-500">
                  <span className="text-green-600 font-medium">↑ 3%</span> from last assessment
                </p>
                <div className="mt-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="md:col-span-2 bg-white shadow-md rounded-xl border border-gray-100">
                <CardHeader className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-t-xl">
                  <CardTitle className="text-lg font-semibold text-gray-800">Health Insights Overview</CardTitle>
                ...
                <CardContent className="pt-6">
                  <div className="space-y-6">
                    {files
                      .filter((file) => file.status === "complete" && file.insights && file.insights.length > 0)
                      .map((file) => (
                        <div key={file.id} className="border-b border-gray-200 pb-4 last:border-0">
                          <div className="flex justify-between items-start mb-2">
                            <div>
                              <h4 className="font-semibold text-gray-800">{file.name}</h4>
                              <p className="text-sm text-gray-500">Analyzed on {file.date}</p>
                            </div>
                            <Badge className="bg-green-100 text-green-700 border-green-200">Analyzed</Badge>
                          </div>
              ...
              <div className="space-y-6">
                <Card className="bg-white shadow-md rounded-xl border border-gray-100">
                  <CardHeader className="bg-gradient-to-r from-green-50 to-teal-50 rounded-t-xl">
                    <CardTitle className="text-lg font-semibold text-gray-800">Health Categories</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium text-gray-700">Metabolic</span>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium text-gray-700">Nutritional</span>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium text-gray-700">Immune System</span>
                ...
                <Card className="bg-white shadow-md rounded-xl border border-gray-100">
                  <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-xl">
                    <CardTitle className="text-lg font-semibold text-gray-800">Recommended Actions</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-6">
                    <ul className="space-y-4">
                      <li className="flex items-start">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-700">Schedule follow-up for vitamin D levels</p>
                          <p className="text-xs text-gray-500 mt-1">Recommended within 3 months</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="mr-3 mt-0.5 h-5 w-5 rounded-full bg-blue-200 flex items-center justify-center">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-700">Increase iron-rich foods in diet</p>
                          <p className="text-xs text-gray-500 mt-1">To address mild anemia</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="mr-3 mt-0.5 h-5 w-5 rounded-full bg-blue-200 flex items-center justify-center">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-700">MRI follow-up for right knee</p>
                          <p className="text-xs text-gray-500 mt-1">Due in April 2024</p>
                        </div>
                      </li>
                    </ul>
                  </CardContent>
              ...
              <Card className="bg-white shadow-md rounded-xl border border-gray-100">
                <CardHeader className="bg-gradient-to-r from-teal-50 to-green-50 rounded-t-xl">
                  <div className="flex justify-between items-center">
                    <div>
                      <CardTitle className="text-lg font-semibold text-gray-800">Report History</CardTitle>
                      <CardDescription className="text-gray-600">
                ...
                <CardContent className="pt-6">
                  <div className="rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-200">
                      {files.map((file) => (
                        <div key={file.id} className="grid grid-cols-5 p-4 items-center hover:bg-gray-50">
                          <div className="col-span-2 flex items-center space-x-3">
                            <FileText className="h-5 w-5 text-blue-400" />
                            <span className="font-medium text-gray-800">{file.name}</span>
                          </div>
                          <div className="text-gray-600">{file.date || "N/A"}</div>
                          <div className="text-gray-600">{file.type.split("/")[1].toUpperCase()}</div>
                          <div>
                            {file.status === "complete" ? (
                              <Badge className="bg-green-100 text-green-700 border-green-200">Analyzed</Badge>
                            ) : file.status === "uploading" ? (
                              <Badge className="bg-blue-100 text-blue-700 border-blue-200">Uploading</Badge>
                            ) : (
